...
class DOOMessageAdapter extends TypeAdapter<DOOMessage> {
  ...
  @override
  void write(BinaryWriter writer, DOOMessage obj) {
    writer
      ..writeByte(9)
      ..writeByte(0)
      ..write(obj.id)
...
DOOMessage _$DOOMessageFromJson(Map<String, dynamic> json) => DOOMessage(
...
Map<String, dynamic> _$DOOMessageToJson(DOOMessage instance) =>
    <String, dynamic>{
      'id': instance.id,
